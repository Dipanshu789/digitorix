...
import profileImg from '../assets/digitornix.png';
  ...
  return (
    <CenteredWrapper>
      <div className="info-section">
        ...
        <p>
          Dipanshu Sahoo is the founder and admin of Digitornix, a passionate technologist dedicated to delivering innovative IT solutions and digital services. With a strong background in software development and consulting, Dipanshu leads the team to help businesses grow in the digital era.
        </p>
        <h3>About Digitornix</h3>
        <p>
          Digitornix is a forward-thinking startup focused on IT consulting, digital transformation, and custom software development. Our mission is to empower clients with cutting-edge technology and reliable support, ensuring their success in a rapidly evolving digital world.
        </p>
      </div>
      <div className="card">
        ...
        <div className="bottom">
          <div className="content">
            <span className="name">Dipanshu Sahoo</span>
            <span className="about-me">Founder & Admin of Digitornix. Reach out for IT consulting, digital solutions, and more!</span>
          </div>
          <div className="bottom-bottom">
            <div className="social-links-container">
              ...
              <a href="https://github.com/Dipanshu789" target="_blank" rel="noopener noreferrer">
